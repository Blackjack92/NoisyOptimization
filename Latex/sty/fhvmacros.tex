...
\newcommand{\getItalicTitle}{\textit{\getTitle}}

\newcommand{\getStudyProg}{\textit{STUDYPROG}}
\newcommand{\setStudyProg}[1]{\renewcommand{\getStudyProg}{\textit{#1}}}


\newcommand{\getInstituteLocation}{Dornbirn, Austria}
\newcommand{\setInstituteLocation}[1]{\renewcommand{\getInstituteLocation}{#1}}

\newcommand{\getInstituteGraphic}{\includegraphics[width = 0.5 \textwidth]{./img/fhvlogopdf.pdf}}
\newcommand{\setInstituteGraphic}[1]{\renewcommand{\getInstituteGraphic}{#1}}

\newcommand{\getCity}{AUTHORCITY}
\newcommand{\setCity}[1]{\renewcommand{\getCity}{#1}}
...
\textsc{\Large Master Thesis in the Study Program \getStudyProg
}\\[1.5cm]
%Title
\hrule
